      ...
      >
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className={`text-lg ${aiMode ? 'text-gray-300' : 'text-gray-600'}`}>
            {aiMode ? (
              <>
                Unlock a universe of tutorials, courses, and insights with AI precision.
                <br />
                <span className="italic text-sm text-blue-300">Navigate the cosmos of learning!</span>
              </>
            ) : (
              <>
                Discover tutorials, courses, and resources to enhance your learning.
                <br />
                <span className="italic text-sm">Explore a wide range of topics from programming to science!</span>
              </>
            )}
          </p>
        </div>
              ...
              .map((result, idx) => (
                <div
                  ...
                  className={`p-6 rounded-2xl shadow-md cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 ${
                    aiMode ? 'bg-gray-800/80 hover:bg-gray-700/80 backdrop-blur-sm' : 'bg-white hover:bg-gray-50'
                  } animate-fadeIn`}
